...
5. Merge Incremental Change: If there is any Incremental Change, you must merge it into the code file. If Legacy Code files contain "{filename} to be rewritten", you are required to merge the Incremental Change into the {filename} file when rewriting "{filename} to be rewritten".
